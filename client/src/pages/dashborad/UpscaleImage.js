...
const UpscaleImage = () => {
    ...
    var [scalevalue, updateScaleValue] = useState(4);
        ...
        try {
            ...
            if (!checkpass) {
                ...
                image.onload = async () => {
                    ...
                    if ((width * height) > 1010000 && isProS !== 'true') {
                        setIsLoading(false);
        ...
        if (checkpass && checkSubscribe) {
            ...
            if (imageUrl) {
                try {
                    ...
                    fetch(`/api/upscale?url=${encodedUrl}&scale=${scale}`)
                        .then((response) => {
                            if (!response.ok) {
                ...
                <div className="grid md:grid-cols-2 gap-4">
                    <div className="w-full">
                        ...
                        <div className="items-center mt-5">
                            <span className="ml-2 text-gray-600 font-bold">Scale : {scalevalue}</span>
                            ...
                            <input
                                ...
                                step="1"
                                defaultValue="4"
                                onChange={(e) => updateScaleValue(e.target.value)}
                            />
                        </div>
